...
=======================
Input:  data/processed/songs_features_no_artist.csv
Output: data/splits_no_artist/X_train.pkl, X_test.pkl, y_train.pkl, y_test.pkl
        models/scaler.pkl
...
IN_PATH      = os.path.join(BASE_DIR, "data", "processed", "songs_features_no_artist.csv")
